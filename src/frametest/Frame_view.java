...
public class Frame_view extends Frame implements ActionListener,WindowListener{
	...
	public Frame_view() {    //Ç±Ç±Ç≈ï\é¶Ç≥ÇÍÇÈ
		...
		add(text3);
		button1.addActionListener(this);//ActionpaformedÇ™é¿çsÇ≥ÇÍÇÈÅB
	...
	@Override
	public void actionPerformed(ActionEvent e) {   //é¿ç€Ç…é¿çsÇ∑ÇÈèàóù
		// TODO Auto-generated method stub
